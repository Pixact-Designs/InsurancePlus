        ...
        <nav className='w-full h-30 bg-whitefixed top-0 left-0 z-50'>
            <div className='flex justify-between items-center mx-2'>
                ...
                <div className='hidden md:flex md:text-slate-800 md:text-lg md:justify-center md:my-12 md:mr-8 md:mx-60 space-x-4'>
                    ...
                    <Link href="#" className='mx-2 hover:text-[#00ADEA]'> Who Are We</Link>
                    <Link href="#" className='mx-2 hover:text-[#00ADEA]'> Why Us?</Link>
                    <Link href="#" className='mx-2 hover:text-[#00ADEA]'> Our Story</Link>
                    <Link href="#" className='mx-2 hover:text-[#00ADEA]'> Next Steps</Link>
